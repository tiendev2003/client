...
const EditBanner = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await dispatch(updateBanners({ id, data: updatedFormData })).unwrap();
  ...
  return (
    <div className="user-profile-card add-listing">
      <div className="user-profile-card-header">
        <h4 className="user-profile-card-title">Chỉnh sửa Banner</h4>
        <div className="user-profile-card-header-right">
          <ul className="breadcrumb-menu d-flex gap-3">
            <li>
              <Link to="/admin/banner">Danh sách</Link>
            </li>
            /<li className="active">Chỉnh sửa Banner</li>
          </ul>
        </div>
      </div>
                  ...
                  <div className="listing-upload-wrapper">
                    ...
                    >
                      <span>
                        ...
                        {formData.link_url && !onChangeImage ? (
                          <div className="image-preview">
                            <img
                              src={formData.link_url}
                              alt="Preview"
                              style={{
                                width: "100px",
                                height: "100px",
